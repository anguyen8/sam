...
def get_arguments():
    ...
    parser.add_argument('--exp_num', choices=['a01', 'a02', 'a03', 'a04'],
...
if __name__ == '__main__':
    ...
    method_dict = {'grad': 'Grad', #Not needed
                   'inpgrad': 'InpGrad', #Not Needed
                   'ig': 'IG', # Remaining
                   'lime': 'Lime', # Done
                   'mp': 'MP', # Done
                   'occlusion': 'Occlusion', #Done
                   'sg': 'SmoothGrad', # Remaining
                   }
