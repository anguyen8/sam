...
if __name__ == '__main__':
    ...
    for idx, img_name in enumerate(img_filenames):
        ...
        assert len(gNet_path) == 4, 'Something is wrong in reading the .npy files\n'
        assert len(mNet_path) == 4, 'Something is wrong in reading the .npy files\n'
        assert len(rNet_path) == 4, 'Something is wrong in reading the .npy files\n'
        #############################################################################
        ...
        grid.append([orig_img] + rNet_heatmaps)  # ResNetNet
        grid.append([orig_img] + mNet_heatmaps)  # MadryNetNet
        ...
        row_labels_left = []
        row_labels_left.append((f'GoogleNet\nTarget:\n{im_label_map[int(targ_label)]}',
        ...
        row_labels_left.append(('ResNet50',))
        row_labels_left.append(('MadryNet',))


        row_labels_right = []
        col_labels = [f'Orig_Img', f'Gradient', f'InpxGrad', f'SmoothGrad', 'Integrated Gradients']
        ...
        eutils.zero_out_plot_multiple_patch(grid,
                                            ...
                                            row_labels_right,
                                            col_labels,
                                            file_name=f'time_{f_time}_Plot_Combined_{img_name}.png',
                                            dpi=224,
                                            save=args.save
                                            )
