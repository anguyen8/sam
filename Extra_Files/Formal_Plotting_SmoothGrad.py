...
def get_arguments():
    ...
    parser.add_argument('--exp_name', choices=['a30', 'a31'],
...
if __name__ == '__main__':
    ...
    for idx, img_name in enumerate(img_filenames):
        ...
        row_labels_left = []
        row_labels_right = []
        # col_labels = ['Orig_Img', 'GoogleNet', 'ResNet50', 'MadryNet']
        col_labels = []
        ...
        # for i in range(npy_len_list[0]):
        #    grid.append([img, gNet_heatmaps[i], rNet_heatmaps[i], mNet_heatmaps[i]])
