...
def get_arguments():
    ...
    parser.add_argument('-mn', '--method_name', choices=['grad', 'inpgrad', 'lime'],
...
if __name__ == '__main__':
    ...
    for modelIdx, model_name in enumerate(model_names):
        ...
        for _, img_name in enumerate(img_filenames):
            ...
            if method_name.lower() in ['grad', 'inpgrad']:
                assert num_var == 2, 'Num of variations should be greater than 2'
            ...
            for i1, i2 in req_comb:
                # print(i1, i2)
                scores.append(compute_score(heatmap_list[i1], heatmap_list[i2], method_name, metric_name))
