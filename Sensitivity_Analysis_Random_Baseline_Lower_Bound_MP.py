        ...
        for idx, img_name in enumerate(img_filenames):
            ...
            if method_name.lower() == 'lime':
                ...
                if args.exp_num.lower() == 'a20':
                    npy_str_lists = [i for i in npy_str_lists if 'mT_circ' in i]
            ...
            assert num_var == 1, 'Num of baseline cant be greater than 1'
            ...
            scores.append(compute_score(heatmap_list[0], heatmap_list[1], method_name, metric_name))
