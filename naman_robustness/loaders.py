...
def make_loaders(workers, batch_size, transforms, data_path, data_aug=True, 
    ...
    '''
    make_loaders (INTERNAL FUNCTION):
    This is an internal function that makes a loader for any dataset

    You probably want to call dataset.make_loaders for a specific dataset,
    which only requires workers and batch_size.
    '''
